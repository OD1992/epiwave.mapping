...
# the dimensions of prior_sims$epsilon are:
# the number of simulations x the number of pixels x the number of times

# create an empty multilayer raster for plotting, and fill it in with the simulations
times_plot <- c(1, 2, 3)
...
for (i in seq_along(times_plot)) {
  plot_raster[[i]][cells(grid_raster)] <- prior_sims$epsilon[1, , i]
}
plot(plot_raster)
