...
population_prev_locs <- pop_all_cells[!is.na(prev_index)]
...
#all_s_ts %*% clinical_case_incidence
...
n_surveys <- nrow(prev_surveys_rdt)
idx <- cbind(
  seq_len(n_surveys), # rows
  prev_surveys_rdt$date #data$epi_data$prevalence_surveys$time # columns
)
...
# model
positive <- prev_surveys_rdt$n_positive #data$epi_data$prevalence_surveys$n_positive
tested <- prev_surveys_rdt$n_sampled
